            ...
            <div class="row">
                <div class="col-sm-4 col-md-3 service-sidebar">
                    <div class="panel-group" id="accordion">
                        <div class="panel">
                            <div>
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Pre Arrival Offers</a>
                            </div>
                        ...
                        <div class="panel">
                            <div>
                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse2">Post Arrival Offers</a>    
                            </div>
                            <div id="collapse2" class="panel-collapse collapse">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a data-toggle="tab" href="#service8" data-target="#service8">Family Care Needs</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-8 col-md-9 service-content">                    
                    <div class="tab-content">
                        <div id="service1" class="tab-pane fade in active">                        
                            ...
                            <p>Express Entry is a selection system for Canadian immigration, designed to select skilled workers for immigration to Canada.</p><p>Express Entry is a completely electronic process involving the federal government, provincial governments, and Canadian employers. In order to best serve your needs, please choose whether you are a potential candidate for Canadian immigration or a Canadian employer interested in hiring skilled workers.We assess your credentials and help you plan on when and how to apply for immigration.We get your documents ready,submit your profile and apply for your permanent residence visa for you.</p>
                        </div>
                        ...
                        <div id="service5" class="tab-pane fade">
                            ...
                            <p><strong>We offer support for a smooth soft landing in Canada for you and your family.</strong></p>
                        ...
                        <div id="service6" class="tab-pane fade">
                            ...
                            <h3>Career Transition</h3>
                            <p><strong> Introducing you to head hunters and preparing you to apply for the right job with the right tools will be our priority after you land in Canada</strong></p>
                            <p>All jobs are not openly advertised in Canada.Your job search needs to involve a variety of strategies and professional networking. We will provide you with the right tools and information to connect with the right people at the right time. From writing your resume and cover letters all will be taken care of by EASI to get you started on your career goals.</p>
                        </div>
                        <div id="service7" class="tab-pane fade">
                            ...
                            <h3>Housing</h3>
                            <p><strong>We will help you find the right house for you and your family in the best neighbourhoods of GTA</strong></p>
