...
//     wp_register_script('load-more-script', get_template_directory_uri() . '/js/load_more.js');
// 	wp_enqueue_script('load-more-script');

// 	wp_register_script('min.js',  get_template_directory_uri().'/js/jquery-3.6.4.min.js');
...
function my_load_scripts(){
	wp_register_script( 'load-more-script', get_template_directory_uri().'loadmore.js');
	wp_enqueue_script ( 'load-more-script');
