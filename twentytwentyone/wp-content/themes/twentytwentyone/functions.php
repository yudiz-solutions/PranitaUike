...
if ( ! function_exists( 'wp_get_list_item_separator' ) ) :
	...
	function wp_get_list_item_separator() {
		...
		//localize
		// wp_localize_script( 'my_loadmore', 'misha_loadmore_params', array('ajaxurl' => admin_url( 'load_more.php' ), 
 ...
 function custom_post_type() {
    ...
    // Set other options for Custom Post Type
		...
		wp_register_script( 'my_loadmore', get_stylesheet_directory_uri() . '/assets/js/load_more.js',);
		wp_enqueue_script( 'my_loadmore' );
        
		wp_register_script( 'my_loadmore1', get_stylesheet_directory_uri() . '/assets/js/min.js');
		wp_enqueue_script( 'my_loadmore1' );
		...
		add_action('wp_ajax_my_load_more', 'my_load_more');
        add_action('wp_ajax_nopriv_my_load_more', 'my_load_more');
