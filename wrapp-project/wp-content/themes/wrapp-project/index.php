    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1><?php echo $top_heading ?> All your ideas in one place</h1>
        ...
        <div class="innercontainer">
            <div class="row">
                <div class="col-md-6 col-sm-12 col-lg-3">
                    <div class="content-1">
                        <figure>
                            <img src="./images/fermentum.svg" alt="image">
                        </figure>
                        <h3>Fermentum amet</h3>
                        <p>Pellentesque quis tincidunt sit sed. Tortor massa sed habitant.</p>
                    </div>
                </div>
                <!-- Cols ends -->
                <div class="col-md-6 col-sm-12 col-lg-3">
                    <div class="content-1">
                        <figure>
                            <img src="./images/digni-1.svg" alt="image">
                        </figure>
                ...
                <div class="col-md-6 col-sm-12 col-lg-3">
                    <div class="content-1">
                        <figure>
                            <img src="./images/digni-2.svg" alt="image">
                        </figure>
                        <h3>Dignissim quam</h3>
                        <p>Pellentesque quis tincidunt sit sed. Tortor massa sed habitant.</p>
                    </div>
                ...
                <div class="col-md-6 col-sm-12 col-lg-3">
                    <div class="content-1">
                        <figure>
                            <img src="./images/risus.svg" alt="image">
                        </figure>
                        <h3>Risus morbi</h3>
                        <p>Pellentesque quis tincidunt sit sed. Tortor massa sed habitant.</p>
                    </div>
    ...
    <div class="brainstorm-wrapper">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-6 col-xxl-6 brain-img">
                <figure>
                    <img src="./images/easily-brain-1.svg" alt="brainstorm-img">
                </figure>
            </div>
            <div class="col-md-12 col-lg-12 col-xl-6 col-xxl-6 brain-text">
                <div class="brainright">
                    <h4>TEAM WORK</h4>
                    <h2>Easily brainstorm with your team </h2>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-12">
                        <img src="./images/easily-brain-2.svg" alt="brainstorm-img">
                    </div>
                    <div class="col-md-2 col-sm-12 col-12">
                        <img src="./images/easily-brain-3.svg" alt="brainstorm-img">
                    </div>
                    <div class="col-md-4 col-sm-12 col-12">
                        <img src="./images/easily-brain-4.svg" alt="brainstorm-img">
                    </div>
                    <div class="col-md-2 col-sm-12 col-12">
                        <img src="./images/easily-brain-5.svg" alt="brainstorm-img">
                    </div>
                </div>
        </div>
    </div>
   ...
   <section class="find-similar">
        <div class="container">
            <div class="find-top text-center common-padding">
                <h2>Find similar stories</h2>
                <p>Aliquet sed nulla tincidunt pulvinar sed fames sit facilisis dictumst. Ornare faucibus quis velit fringilla aliquam ultricies. Malesuada ut aliquam at ac est nisi, interdum etiam dignissim. Sed ut vestibulum eget purus ornare. Risus elit et fringilla habitant ut facilisi.</p> 
            </div>
