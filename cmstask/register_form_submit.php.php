...
$result  = array();
    ...
    if( empty($confirm_password)){
        $has_error = true;
        $result['confirm_password'][] = 'Please enter confirm password';
    }
    ...
    if( !$has_error){
        ...
        $sql = "INSERT INTO `user` (`id`, `first_name`,  `last_name`,`username`, `email`, `password`, 'confirm_password',`dob`, `hobby`, `gender`, `country`, `message`, `profile_image`) 
        VALUES (NULL, '$first_name',  '$last_name', '$username','$email', '$password','$confirm_password' ,'$dob', '$hobby', '$gender', '$country', '$message', '$profile_image')";
