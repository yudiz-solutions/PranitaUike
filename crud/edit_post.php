...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE  post
    SET post_image ='$post_image , caption = '$caption', hashtag = '$hashtag' WHERE id = $id";
            ...
            <form action=" " method="post" style="width : 50vw; min-width : 300px;">
                <div class="row mb-3">
                    ...
                    <div>
                        ...
                        <textarea id="bio" name="caption"  rows="4" cols="50" value="<?php echo $row['caption']?>">
                    </textarea>
                    </div>

                    <div>
                        <label for="bio">Hashtag:</label></p>

                        <textarea id="bio" name="hashtag" rows="4" cols="50" value="<?php echo $row['hashtag']?>">
